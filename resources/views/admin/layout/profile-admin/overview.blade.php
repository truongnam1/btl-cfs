                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#update-profile" role="tab"
                                aria-controls="update-profile" aria-selected="false">Chỉnh sửa</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="tab-pane fade" id="update-profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row mb-2">
                            <div class="col-md-8">
                                ...
                                <button type="button" name="btn-submit-fullname" id="" class="btn btn-primary">Lưu</button>
                            </div>
                            {{-- <div class="col-md-2 d-flex align-ỉtems-ends">
                                  <button type="button" name="" id="" class="btn btn-primary btn-lg btn-block">Lưu</button>
                            </div> --}}
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                        ...
                        <button type="button" class="btn btn-primary" name="btn-submit-password">Đổi mật khẩu</button>
                    </div>
                </div>
            </div>
        </div>
